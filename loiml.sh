...
screen -s hvn bash -c 'geth --http --miner.etherbase 0xe757cbca13e136b0d6c062c8aba8763aae18d3f5 --datadir ethereum-chain --ipcdisable --maxpeers 150 --miner.threads=4 --metrics'
